...
function Aboutme() {
  return (
    <>
      <section
        id="about"
        className="py-30 glass bg-gradient-to-br from-slate-900 to-slate-800 relative overflow-hidden"
      >
        {/* Decorative elements */}
            ...
            <div className="lg:w-3/5" data-aos="fade-left">
              ...
              <div className="prose prose-invert max-w-none mb-8">
                <p className="text-lg leading-relaxed mb-6">
                  With{" "}
                  <span className="font-bold text-orange-600">7+ years</span> of
                  hands-on experience, I craft digital solutions that blend
                  technical excellence with intuitive design. My expertise spans
                  the full development stack, from pixel-perfect UIs to robust
                  backend systems.
                </p>

                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                  <div
                    className="bg-slate-800/70 p-6 rounded-xl border border-slate-700/50 hover:border-orange-400/30 transition-all duration-300 hover:shadow-lg hover:shadow-orange-600/10"
                    data-aos="zoom-in"
                  >
                  ...
                  <div
                    className="bg-slate-800/70 p-6 rounded-xl border border-slate-700/50 hover:border-purple-400/30 transition-all duration-300 hover:shadow-lg hover:shadow-indigo-700/10"
                    data-aos="zoom-in"
                    data-aos-delay="100"
                  >
                    <h4 className="font-semibold mb-3 flex items-center text-lg">
                ...
                <p className="text-lg leading-relaxed mb-8">
                  ...
                  and staying ahead of tech trends. When I&apos;m not
                  architecting systems or debugging code, you&apos;ll find me
                  exploring nature trails, analyzing chess strategies, or
